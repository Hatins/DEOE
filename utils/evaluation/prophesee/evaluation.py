...
def evaluate_list(result_boxes_list,
    ...
    if camera == 'gen1':
        ...
        classes = [ 'pedestrians','two wheelers', 'cars', 'trucks', 'buses'] 
    elif camera == 'dsec':
        classes = ['pedestrians', 'cars', 'rider', 'bus', 'truck', 'bicycle', 'motorcycle', 'train']
    else:
    ...
    return evaluate_detection(gt_boxes_list, result_boxes_list,
                              ...
                              classes=classes, return_aps=return_aps, ignored = ignored)
