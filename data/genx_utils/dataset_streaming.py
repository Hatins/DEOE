...
from data.utils.types import DatasetMode, DatasetMode, DatasetType
...
def get_sequences(path: Path, dataset_mode: DatasetMode, dataset_config: DictConfig, guarantee_labels: bool) -> List[SequenceForIter]:
    assert path.is_dir()
